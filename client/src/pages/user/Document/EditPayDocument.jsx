...
//   }, [document])
  ...
  const postForm = async (data) => {
    ...
    await newRequest
      .patch(`/document/payedit/${data.id}`, formDataToSend, {
        headers: {
      ...
      .then((response) => {
        if (response.data.error) {
          ...
          toast.success("Chỉnh sửa tài liệu bán thành công, chờ quản trị viên kiểm duyệt!", {});
          navigate("/profile");
        }
      });
  };

  if (major.isLoading || document.isLoading) return <LoadingCompoment />;
  if (major.error || document.error) return <ErrorCompoment />;
  return (
    <>
      <HeaderPage page={"Chỉnh sửa tài liệu đăng bán"} />
            ...
            <div className="col-lg-10">
              <div className="checkout-content-wrapper">
                <div id="billing-form">
                  ...
                  <div className="row">
                    <Formik
                      initialValues={document.data?.Tai_lieu}
...
export default EditPayDocument;
